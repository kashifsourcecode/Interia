...
return [
    ...
    */
    ...
    | components like single and multi-file components. These folders'll
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | This value is used to specify where Livewire Blade templates are
    | stored when running creation commands like `artisan make:livewire`.
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | Use the `public` disk so previews work with `php artisan storage:link`.
    | Ensure APP_URL matches the URL you open in the browser (Filament admin).
    |
    */
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | Default max_size is 1MB which breaks Filament modal uploads that embed
    | file metadata in Livewire payloads.
    |
    */

    'payload' => [
        'max_size' => env('LIVEWIRE_PAYLOAD_MAX_SIZE', 15 * 1024 * 1024),
